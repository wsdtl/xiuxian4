...
- 战斗底座 `combat.foundation.v6`，由核心会话自动产生完整结构化轨迹
...
- 七十四把多世界完整投影武器、独立战斗循环和统一目标白名单
- 毫秒级武器静态估值与约四秒完成的 9472 实例品质分布巡检
