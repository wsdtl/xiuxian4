...
STELLAR_RING_DISASTERS = (
    _disaster(
        "talos", "final_guardian", DISASTER_ORIGIN_DOCUMENTED,
        "古希腊神话中的青铜巨人塔罗斯",
    ...
    _disaster(
        "laplace_demon", "celestial_rebel", DISASTER_ORIGIN_DOCUMENTED,
        "拉普拉斯妖思想实验",
    ...
    _disaster(
        "maxwell_demon", "realm_breaker", DISASTER_ORIGIN_DOCUMENTED,
        "麦克斯韦妖思想实验",
    ...
    _disaster(
        "frankenstein", "soul_ferryman", DISASTER_ORIGIN_DOCUMENTED,
        "玛丽·雪莱《弗兰肯斯坦》",
    ...
    _disaster(
        "babel_engine", "realm_breaker", DISASTER_ORIGIN_DOCUMENTED,
        "《创世记》巴别塔叙事",
    ...
    _disaster(
        "daedalus_maze", "realm_breaker", DISASTER_ORIGIN_DOCUMENTED,
        "古希腊神话代达罗斯迷宫",
    ...
    _disaster(
        "brazen_bull", "iron_titan", DISASTER_ORIGIN_DOCUMENTED,
        "古希腊传说中的法拉里斯铜牛",
    ...
    _disaster(
        "thirteenth_engine", "iron_titan", DISASTER_ORIGIN_ORIGINAL,
        "原创星环灾厄",
    ...
    _disaster(
        "redshift_burial", "world_leviathan", DISASTER_ORIGIN_ORIGINAL,
        "原创天体灾厄",
    ...
    _disaster(
        "terminal_swarm", "nine_headed_plague", DISASTER_ORIGIN_ORIGINAL,
        "原创机械灾厄",
