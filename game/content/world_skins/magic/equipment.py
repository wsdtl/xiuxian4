...
_SET_DISPLAY = {
    ...
    "blood_moon": ("德古拉血月套装", "暴击、汲取与持续作战协同"),
    "thunder_judgment": ("索尔雷霆裁决套装", "攻速与暴击控制协同"),
    "thorn_crown": ("涅墨亚棘冠套装", "格挡减伤与反震协同"),
    "spirit_tide": ("波塞冬灵潮套装", "魔力上限与回合恢复协同"),
    "hunters_mark": ("阿尔忒弥斯猎印套装", "命中、增伤与迟缓协同"),
    "immortal_guard": ("赫拉克勒斯不灭套装", "生命、抗性与受创恢复协同"),
}
